...
## `/proc/cpuinfo`
Contains detailed hardware information such as number of processors and processor speed.
...
See [huge pages](huge_pages.md) for more information.
...
$ ll /proc/<pid>/fd
lr-x------ 1 user 64 Aug  4 15:23 0 -> 'pipe:[68332]'
lrwx------ 1 user 64 Aug  4 15:23 20 -> 'socket:[76831]'
lr-x------ 1 user 64 Aug  4 15:23 22 -> anon_inode:inotify
```

`0=stdin, 1=stdout, 2=stderr`.

### `/proc/<pid>/cwd`
Return cwd ([`pwdx`](pwdx.md)) of process.

```bash
$ ls -l /proc/1161371/cwd
lrwxrwxrwx. 1 user user 0 Jan 16 20:31 /proc/1161371/cwd -> /home/user/my_application
```
