...
#travis bindkey '^[[H' beginning-of-line          # home
...
HISTSIZE=10000000 # travis: default 1000
SAVEHIST=20000000 # travis: default 2000
setopt hist_expire_dups_first # delete duplicates first when HISTFILE size exceeds HISTSIZE
setopt hist_ignore_dups       # ignore duplicated commands history list
setopt hist_ignore_space      # ignore commands that start with space
#setopt hist_verify           # show command with history expansion to user before running it
                              # travis: not setting hist_verify is consistent with bash:
                              # touch file.txt; ll !$
                              # ^does not require extra enter keypress
...
if [ "$color_prompt" = yes ]; then
    ...
    if [ -f /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]; then
        ...
        # travis, for light theme, make unknown commands easier to read:
